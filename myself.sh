...
#
# Copyright (C) 2023 FlaminG0
#
# Xray-script: https://github.com/FlaminG0/Xray-script
#
# XTLS Official:
...
# xray script
readonly XRAY_SCRIPT_PATH="/usr/local/etc/FlaminG0_xray_script"
...
function config_nginx() {
  ...
  _error_detect "curl -fsSL -o "${NGINX_CONFIG_PATH}/nginx.conf" "https://raw.githubusercontent.com/FlaminG0/Xray-script/main/nginx/conf/nginx.conf""
  _error_detect "curl -fsSL -o "${NGINX_CONFIG_PATH}/sites-available/example.com.conf" "https://raw.githubusercontent.com/FlaminG0/Xray-script/main/nginx/conf/sites-available/example.com.conf""
  _error_detect "curl -fsSL -o "${NGINX_CONFIG_PATH}/conf.d/restrict.conf" "https://raw.githubusercontent.com/FlaminG0/Xray-script/main/nginx/conf/conf.d/restrict.conf""
  _error_detect "curl -fsSL -o "${NGINX_CONFIG_PATH}/nginxconfig.io/limit.conf" "https://raw.githubusercontent.com/FlaminG0/Xray-script/main/nginx/conf/nginxconfig.io/limit.conf""
  case "${choice_domain}" in
  1)
...
function install_update_xray() {
  ...
  if [[ ! -f "${XRAY_SCRIPT_PATH}/update_dat.sh" ]]; then
    ...
    _error_detect "curl -fsSL -o ${XRAY_SCRIPT_PATH}/update_dat.sh https://raw.githubusercontent.com/FlaminG0/Xray-script/main/tool/update-dat.sh"
...
function config_xray() {
  ...
  _error_detect 'curl -fsSL -o /usr/local/etc/xray/config.json https://raw.githubusercontent.com/FlaminG0/Xray-script/main/VLESS-XTLS-uTLS-REALITY/myself.json'
  # x25519
...
function install_xray_config_manage() {
  ...
  _error_detect "curl -fsSL -o ${XRAY_CONFIG_MANAGE} https://raw.githubusercontent.com/FlaminG0/Xray-script/main/tool/xray_config_manage.sh"
...
function install_cloudreve() {
  ...
  _error_detect "curl -fsSL -o ${CLOUDREVE_PATH}/docker-compose.yaml https://raw.githubusercontent.com/FlaminG0/Xray-script/main/cloudreve/docker-compose.yaml"
  cd "${CLOUDREVE_PATH}"
  ...
  _error_detect "curl -fsSL -o ${XRAY_SCRIPT_PATH}/cloudreve_watchtower.sh https://raw.githubusercontent.com/FlaminG0/Xray-script/main/cloudreve/watchtower.sh"
...
function install_cloudflare_warp() {
  ...
  _error_detect "curl -fsSL -o ${CLOUDFLARE_WARP_PATH}/Dockerfile https://raw.githubusercontent.com/FlaminG0/Xray-script/main/cloudflare-warp/Dockerfile"
  _error_detect "curl -fsSL -o ${CLOUDFLARE_WARP_PATH}/startup.sh https://raw.githubusercontent.com/FlaminG0/Xray-script/main/cloudflare-warp/startup.sh"
...
function install() {
  ...
  # Script config
  _error_detect "curl -fsSL -o ${XRAY_SCRIPT_PATH}/config.json https://raw.githubusercontent.com/FlaminG0/Xray-script/main/config/myself.json"
  # Firewall
  firewall_manage
...
function update_kernel() {
  bash <(wget -qO- https://raw.githubusercontent.com/FlaminG0/system-automation-scripts/main/update-kernel.sh)
}

# 202.remove kernel
function remove_kernel() {
  bash <(wget -qO- https://raw.githubusercontent.com/FlaminG0/system-automation-scripts/main/remove-kernel.sh)
}
...
function optimize_kernel_parameters() {
  ...
  if [[ "${is_opt}" =~ ^[Yy]$ ]]; then
    ...
    # sysctl
    _error_detect "curl -fsSL -o /etc/sysctl.d/99-sysctl.conf https://raw.githubusercontent.com/FlaminG0/Xray-script/main/config/sysctl.conf"
    sysctl -p
  fi
}
